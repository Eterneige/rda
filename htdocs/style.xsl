...
<p>Si vous êtes deux ou plus à vouloir prendre en charge le même député :</p>
<ul>
...
<li>Vous tenez tous les deux à contacter la/le même député(e) <br/> &rarr; On peut joindre deux lettres en même temps. Ou faire une lettre commune. Discutez-en entre vous !</li>
</paragraph>
<ul>
