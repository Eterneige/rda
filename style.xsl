...
<ul>
<li>L'un(e) des deux habite dans la circonscription ou a un lien particulier avec le député <br/>&#8594; Serait-il possible de lui laisser la priorité ?</li>
<li>Vous tenez tous les deux à contacter la/le même député(e)<br/> &#8594; On peut joindre deux lettres en même temps. Ou faire une lettre commune. Discutez-en entre vous !</li></ul></p>
</paragraph>
<ul>
